...
<description>Updates to Mystic and the Mystic API.</description>
<url>changelog</url>

# Changelog
This changelog has been moved to the Mystic Discord server and is now deprecated.
...
- `/bots/new` -> user owner must be in the Mystic server to create bot listings
...
- Mystic bot -> messaged when user left Mystic server
...
[Mystic](/) and the Mystic Discord Server was released!
